...
export const TitleScreen: FC<TitleScreenProps> = ({ stage, setOnMenu }) => {
    ...
    const buttonProps = {outline: 1, backgroundColor: '#FF0000CC', color: 'primary.main', typography: 'h4', m: 1};
    ...
    return (
        <div style={{
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '2vh', width: '100vw', alignItems: 'center'}}>
                {generating ? (
                    <>
